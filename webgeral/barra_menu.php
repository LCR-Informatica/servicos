...
<div class="container-fluid barra-cliente">
    <?php if (funcoes::VerificarLogin()) : ?>
        <div class="dropdown text-warning">
            ...
            <a href="" class="ml-1 mr-2 dropdown-toggle" id="d1" data-toggle="dropdown" 
              aria-haspopup="true" aria-expanded="false"><i class="fa fa-cog"></i> Menu</a>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu bg-dark text-light" aria-labelledby="dropdownMenuButton">
                <form class="p-3" action="?a=login" method="post">
                    ...
                    placeholder="Usuário" pattern=".{4,20}" 
                    title="Entre 4 e 20 caracteres" required>
                    <input type="password" class="form-control mb-3" name="senha" 
                    placeholder="Senha" pattern=".{4,20}" 
                    title="Entre 4 e 20 caracteres" required>
                    <div class="text-center mb-2"><a 
                    href="?a=recuperar-senha">Esqueceu a senha?</a></div>
                    <div class="text-center"><button type="submit" 
                    class="mt-2 btn btn-primary">Entrar</button></div>
                </form>
            </div>
        </div>
    <?php endif; ?>
