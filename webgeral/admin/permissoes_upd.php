...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // LOG
    funcoes::CriaLOG($_SESSION['nome_usuario'], 'alterou as permissoes do usuario ' .
        $user[0]['nome'] . ' no BD');
                ...
                <div class="card mt-1 mb-1">
                    ...
                    <div class="row mb-3">
                        <div class="col pl-3 pr-3">
                            <h5 class="text-center"><strong>Usuário: <?= $user[0]['nome'] ?>
                              </strong></h5>
                            <hr>
                            <form action="?a=permissoes-upd&id=<?= $id ?>" method="post">
                                <div class='row m-3'>
                                    <?php
                                    $id = 0;
                                    $perm = $ps;
