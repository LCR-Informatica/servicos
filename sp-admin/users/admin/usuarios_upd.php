...
<?php if ($permitido) : ?>
    ...
    <?php if (!$erro) : ?>
        ...
        <div class="container card col-md-6 offset-md-3 mt-3 mb-3">
            ...
            <div class="row mb-2">
                <div class="col">
                    <form action="?a=usuarios-upd&id=<?php echo $id ?>" method="post">
                        <div class="col-md-12 pt-2 pb-1">
                            <div class='row ml-2 form-group'>
                                ...
                                <input class='col-sm-9 form-control' type="text" name="txt-usuario" value="<?php echo $user[0]['usuario'] ?>" readonly>
                            </div>
                            <div class='row ml-2 form-group'>
                                <label class="col-sm-2 col-form-label"><strong>Nome:</strong></label>
                                <input class='col-sm-9 form-control' type="text" name="txt-nome" required placeholder="Digite o nome do usuário" pattern=".{4,50}" title="Entre 4 e 50 carcateres." value="<?php echo $user[0]['nome'] ?>">
                            </div>
                            <div class='row ml-2 form-group'>
                                <label class="col-sm-2 col-form-label"><strong>Email:</strong></label>
                                <input class='col-sm-9 form-control' type="email" name="txt-email" required placeholder="Digite o email do usuário" pattern=".{4,50}" title="Entre 4 e 50 carcateres." value="<?php echo $user[0]['email'] ?>">
                            </div>
                        </div>
                        <hr>
